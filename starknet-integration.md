...
- `class_hash`, the constructor-calldata layout, and the salt rule become **consensus-critical CSAP constants** (a class upgrade changes all future stealth addresses); they are added to [CSAP.md] with test vectors.
